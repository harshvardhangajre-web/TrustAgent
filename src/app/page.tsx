  ...
  return (
    <main className="relative flex min-h-[calc(100vh-3.5rem)] flex-col items-center justify-center overflow-hidden px-6 py-20">
      ...
      {[
        ...
        <div key={i}
          className={`pointer-events-none absolute ${cls} h-8 w-8 border-cyan-DEFAULT/30`}
      ...
      <div className="flex max-w-2xl flex-col items-center gap-8 text-center">
        ...
        <div className="grid w-full max-w-md grid-cols-3 gap-2">
          {[
            ...
            <div key={label}
              ...
              <span className="font-mono text-xs font-bold text-cyan-DEFAULT">{label}</span>
        ...
        <p className="font-mono text-[10px] text-muted-foreground/60">
          ...
          <a href="https://explorer-mezame.shardeum.org" target="_blank" rel="noopener noreferrer"
            className="hover:text-cyan-DEFAULT transition-colors underline underline-offset-2">
